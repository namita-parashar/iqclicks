...
class AffiliateNetworkHelper{
        ...
        $tracker_affiliate_network = new AffiliateNetwork;
        ...
        $tracker_affiliate_network->accept_duplicate_postback = $data['accept_duplicate_postback'] ?? "1";
        $tracker_affiliate_network->append_clickid = $data['append_clickid'] ?? "1";
        $tracker_affiliate_network->accept_postback_from_whitelist = $data['accept_postback_from_whitelist'] ?? "1";
        $tracker_affiliate_network->notes = $data['notes'] ?? "Untitled";
        $tracker_affiliate_network->affiliate_network_id = $network->id;
        $tracker_affiliate_network->agency_id = $agency->id;
    ...
    public static function update(AffiliateNetwork $tracker_affiliate_network,Network $network,Agency $agency,Timezone $timezone , $data=[]){
    ...
    public static function delete(AffiliateNetwork $tracker_affiliate_network){
