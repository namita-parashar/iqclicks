...
use App\Models\Affiliate\NetworkParameters;

class NetworkParameterHelper{

    public static function create(Network $network,$data=[]){
        $network_parameters = new NetworkParameters;
    ...
    public static function update(NetworkParameters $network_parameters,Network $network,$data=[]){
    ...
    public static function delete(NetworkParameters $network_parameters){
